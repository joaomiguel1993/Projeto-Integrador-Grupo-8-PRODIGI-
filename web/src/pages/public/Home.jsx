    ...
    return (
        <button
            className={`hospital-card ${
                !ativo ? 'hospital-card--offline' : ''
            }`}
            onClick={() => onClick(hospital)}
            aria-label={`${textos.home?.labelHospitais || 'Hospital'} ${
                hospital.nome
            }`}
        >
            <div className="hospital-card__header">
                <div className="hospital-card__title-row">
                    ...
                    <span
                        className="hospital-card__status"
                        style={{
                            background: ativo
                                ? '#22c55e'
                                : '#94a3b8',
            ...
            <div className="hospital-card__footer">
                <div className="hospital-card__wait">
                    <span className="hospital-card__wait-label">
                        {textos.home?.labelEspera ||
                            'Média (Urgente)'}
                    </span>

                    <strong
                        className="hospital-card__wait-value"
                        style={{
                ...
                <span className="hospital-card__button">
                    Ver Detalhes
                </span>
            </div>
        </button>
...
function SkeletonCard() {
    return (
        <div
            className="hospital-card hospital-card--skeleton"
            aria-hidden="true"
        >
            <div
                className="skeleton"
    ...
    useEffect(() => {
        async function loadData() {
            try {
                ...
                setError(
                    'Erro ao sincronizar com servidor de IA.'
                );
            } finally {
                setLoading(false);
            }
            ...
            <section className="info-section">
                <div className="container">
                    <div className="info-carousel">
                        <h2 className="info-carousel__title">
