export const TEXTOS_PT = {
  ...
  admin: {
    ...
    botaoSair: "Sair",
    descUtilizadores: "Gestão de contas de acesso, contas por criar e utilizadores bloqueados.",
    descFuncionarios: "Gerir funcionários existentes, criar novos registos e associar hospitais.",
    descHospitais: "Lista dos hospitais existentes e edição no painel central.",
    descRelatorios: "Resumo e histórico de atividade.",
    ...
    relTotalExistente: "Total existente",
    relFuncionariosSemAcesso: "Funcionários sem acesso",
    colData: "Data",
    colAcao: "Ação",
    colDetalhe: "Detalhe",
    semHistorico: "Sem histórico.",
    tblUtilizadoresComConta: "Utilizadores com conta",
    tblFuncionariosSemConta: "Funcionários sem utilizador",
    tblUtilizadoresBloqueados: "Utilizadores bloqueados",
    sucessoEditarUser: "Utilizador atualizado com sucesso.",
    semBloqueados: "Sem utilizadores bloqueados.",
  ...
  sobreNos: {
    ...
    // Textos puros para o Leitor de Voz
  ...
  politicaPrivacidade: {
    ...
    s1Texto2: "incluindo o portal web, aplicação móvel Android e sistemas de triagem, desenvolvidos pelo Grupo 8, no âmbito do Projeto Integrador de 2026. O sistema é concebido para a gestão eficiente de urgências e internamentos, garantindo a proteção de dados sensíveis através de medidas técnicas e organizativas adequadas ao risco clínico.",

    s2Titulo: "2. Responsável pelo Tratamento e Encarregado de Proteção de Dados",
    s2Texto: "A entidade responsável pelo tratamento de dados é o Grupo 8, com supervisão académica no âmbito do projeto PRODIGI/SIAGUH. Para questões sobre privacidade ou exercício de direitos, os utilizadores podem contactar o Encarregado de Proteção de Dados do grupo através do e-mail:",
    ...
    txtDecisao: "Previsão de tempos de espera e gestão de camas de internamento.",
    lblSeguranca: "Segurança:",
    txtSeguranca: "Autenticação de profissionais via JWT e auditoria de acessos para prevenção de fraude.",

    s5Titulo: "5. Utilização de Inteligência Artificial no SIAGUH",
    s5Intro: "O SIAGUH integra um sistema de IA para apoio à triagem. Informamos que:",
    s5Item1: "A IA não decide de forma autónoma, servindo apenas como suporte à decisão do profissional de saúde.",
    s5Item2: "O utilizador humano pode sempre validar, corrigir ou ignorar a sugestão da IA.",
    s5Item3: "Os dados de IA são utilizados para melhorar a precisão do atendimento e reduzir o risco clínico.",

    s6Titulo: "6. Prazo de Conservação e Comunicação",
    lblConserva: "Conservação:",
    txtConserva: "Os dados são mantidos apenas pelo período necessário à prestação de cuidados e cumprimento de obrigações legais.",
    lblComunica: "Comunicação:",
    txtComunica: "Os dados podem ser partilhados entre profissionais do hospital e, em casos de emergência, com entidades externas (INEM) ou por ordem judicial.",

    s7Titulo: "7. Direitos dos Titulares",
    s7Intro: "Os utentes e profissionais gozam dos direitos previstos no RGPD:",
    lblDireito1: "Acesso, Retificação e Apagamento:",
    txtDireito1: "(quando aplicável ao historial clínico).",
    lblDireito2: "Oposição a Decisões Automatizadas:",
    txtDireito2: "O direito de solicitar que uma triagem seja revista exclusivamente por um humano.",
    lblDireito3: "Portabilidade:",
    txtDireito3: "Receber os dados em formato estruturado (JSON/CSV).",
  ...
  receptionist: {
    ...
    descricaoPainel: 'Fluxo rápido de registo, admissão e abertura de episódio.',
    menuPesquisar: 'Pesquisar utente',
    menuCriar: 'Criar utente',
    menuFicha: 'Ficha base',
    menuEntrada: 'Dar entrada',
    ...
    telefone: 'Telefone',
    morada: 'Morada',
    selecionaPesquisa: 'Seleciona um utente na pesquisa.',
    darEntrada: 'Dar entrada no hospital',
    selecionaPrimeiro: 'Seleciona um utente primeiro.',
    abrirEpisodio: 'Abrir episódio de urgência',
    motivo: 'Motivo',
    observacao: 'Observação',
    episodiosRecentes: 'Episódios recentes',
    hospitalAtivo: 'Hospital ativo',
    utente: 'Utente',
    entrada: 'Entrada',
    estado: 'Estado',
    semEpisodios: 'Sem episódios recentes.',
    criarUtente: 'Criar utente',
    dataNascimento: 'Data nascimento',
  }
