      ...
      <div className="footer-sub">
        <div className="container footer-sub__inner">
          <nav className="footer-sub__links" aria-label="Rodapé">
            <Link to="/sobre-nos">{textos?.footer?.sobreNos || 'Sobre Nós'}</Link>
          ...
          <div className="footer-sub__contacts">
            <Link to="/FAQS" className="footer-contact-item">
              ...
              <div className="footer-contact-item__text">
                <span className="footer-contact-item__label">{textos?.footer?.faqLabel || 'Ajuda'}</span>
                <span className="footer-contact-item__value">{textos?.footer?.faqValue || 'FAQ'}</span>
              </div>
            </Link>
            ...
            <a href="tel:+351210000000" className="footer-contact-item">
              ...
              <div className="footer-contact-item__text">
                <span className="footer-contact-item__label">{textos?.footer?.telefoneLabel || 'Contacto'}</span>
                <span className="footer-contact-item__value">{textos?.footer?.telefoneValue || '+351 210 000 000'}</span>
              </div>
            </a>
          </div>
        </div>
