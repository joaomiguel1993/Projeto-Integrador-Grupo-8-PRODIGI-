...
async def test_ct02_ciclo_vida_paciente(
    ...
    r1 = await client.get(f"/api/v1/episodios/{ep_id}")
    ...
    r2 = await client.get(f"/api/v1/episodios/{ep_id}")
    ...
    r3 = await client.get(f"/api/v1/episodios/{ep_id}")
    ...
    r4 = await client.get(f"/api/v1/episodios/{ep_id}")
