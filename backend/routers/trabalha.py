...
from backend.schemas.trabalha import TrabalhaCreate, TrabalhaUpdate, TrabalhaOut
from backend.services import trabalha_service

router = APIRouter(prefix="/api/v1/trabalha", tags=["Trabalha"])
